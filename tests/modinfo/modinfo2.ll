; RUN: llvm-link -S -module-name=test -o %t.1.ll %S/Inputs/link.mod.1.ll %S/Inputs/link.mod.2.ll
; RUN: llvm-link -S -module-name=test2 -o %t.2.ll %t.1.ll %S/Inputs/link.mod.3.ll
; RUN: FileCheck %s -input-file %t.2.ll
